  ...
  return (
    <Container maxWidth="sm" style={{ backgroundColor: "#cfe8fc" }}>
      ...
      <Box display="flex" flexWrap="wrap" m={2}>
        <IconButton aria-label="number-0">
          <Avatar alt="0_Number" src={Number0} />
        </IconButton>

        <IconButton aria-label="number-1">
          <Avatar alt="1_Number" src={Number1} />
        </IconButton>

        <IconButton aria-label="number-2">
          <Avatar alt="2_Number" src={Number2} />
        </IconButton>

        <IconButton aria-label="number-3">
          <Avatar alt="3_Number" src={Number3} />
        </IconButton>

        <IconButton aria-label="number-4">
          <Avatar alt="4_Number" src={Number4} />
        </IconButton>

        <IconButton aria-label="number-5">
          <Avatar alt="5_Number" src={Number5} />
        </IconButton>

        <IconButton aria-label="number-6">
          <Avatar alt="6_Number" src={Number6} />
        </IconButton>

        <IconButton aria-label="number-7">
          <Avatar alt="7_Number" src={Number7} />
        </IconButton>

        <IconButton aria-label="number-8">
          <Avatar alt="8_Number" src={Number8} />
        </IconButton>

        <IconButton aria-label="number-9">
